...
with tab1:
    ...
    with c1:
        ...
        if ECHARTS_AVAILABLE:
            ...
            st.plotly_chart(fig_style(fig_mix, height=390, showlegend=True), use_container_width=True)
    ...
    with c2:
        ...
        if ECHARTS_AVAILABLE:
            ...
            st.plotly_chart(fig_style(fig_comp, height=390, showlegend=True), use_container_width=True)
    ...
    with c3:
        ...
        if ECHARTS_AVAILABLE:
            ...
            st.plotly_chart(fig_style(fig_can_total, height=320, showlegend=False), use_container_width=True)
    ...
    with c4:
        ...
        if ECHARTS_AVAILABLE:
            ...
            st.plotly_chart(fig_style(fig_mix_time, height=320, showlegend=True), use_container_width=True)
    ...
    with c5:
        ...
        if ECHARTS_AVAILABLE:
            ...
            st.plotly_chart(fig_style(fig_donut, height=340, showlegend=True), use_container_width=True)
        ...
        if auto_play and race_src_years:
            for yr in race_src_years:
                ...
                if ECHARTS_AVAILABLE:
                    ...
                    race_src_placeholder.plotly_chart(fig_style(fig_sr, height=340, showlegend=False), use_container_width=True)
...
with tab2:
    ...
    with c3:
        ...
        st.caption("Computed from all Canada sources in the selected year window.")
        rs = (
            base[
                (base["Region"] == "Canada")
                & base["Year"].between(year_min, year_max)
        ...
        if not piv.empty:
            ...
            if ECHARTS_AVAILABLE:
                ...
                st.plotly_chart(fig_style(fig_tr, height=330, showlegend=False), use_container_width=True)
        else:
            st.info("No Canada data is available for the selected year window.")
    ...
    with c4:
        ...
        if not vol.empty:
            ...
            st.plotly_chart(fig_style(fig_vol, height=330, showlegend=True), use_container_width=True)
        else:
    ...
    if ECHARTS_AVAILABLE:
        ...
        st.plotly_chart(fig_style(fig_mom, height=320, showlegend=False), use_container_width=True)
    ...
    if auto_play and years:
        for yr in years:
            ...
            if ECHARTS_AVAILABLE:
                ...
                line_placeholder.plotly_chart(fig_style(fig_line, height=450, showlegend=True), use_container_width=True)
            time.sleep(float(anim_speed))
    elif years:
...
with tab3:
    ...
    if len(series) < 10:
        ...
        with left:
            ...
            st.plotly_chart(fig_style(fig, height=430, showlegend=True), use_container_width=True)
    ...
    if len(series_deliv) < 10:
        ...
        if fc_deliv.empty or met_deliv.empty:
            ...
            if ECHARTS_AVAILABLE and not fo.empty:
                ...
                st.plotly_chart(fig_style(fig_fo, height=300), use_container_width=True)
